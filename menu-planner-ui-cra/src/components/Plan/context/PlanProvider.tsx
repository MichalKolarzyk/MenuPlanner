...
const PlanProvider = (props: any) => {
  ...
  const setDatNumberHandler = (value: any) => {
  ...
  const setStartDateHandler = (value: any) => {
    setStartDate(value);
  ...
  const setUsersHandler = (value: any) => {
    setUsers(value);
