...
namespace MenuPlanner.API.Migrations
{
    ...
    [Migration("20220205111333_DishTypes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MenuPlanner.API.Entities.DishType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MenuPlanner.API.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MenuPlanner.API.Entities.TrustedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MenuPlanner.API.Entities.Dish", b =>
                {
                    b.HasOne("MenuPlanner.API.Entities.DishType", "DishType")
                        .WithMany()
            ...
            modelBuilder.Entity("MenuPlanner.API.Entities.TrustedUser", b =>
                {
                    b.HasOne("MenuPlanner.API.Entities.User", "Trusted")
                        .WithMany()
            ...
            modelBuilder.Entity("MenuPlanner.API.Entities.User", b =>
                {
                    b.HasOne("MenuPlanner.API.Entities.Role", "Role")
                        .WithMany()
